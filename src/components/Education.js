...
const Education = () => {
  ...
  return (
    <section id="education" className='px-10 py-20 lg:px-40 text-center  bg-brow'>
      ...
      <div >
        ...
        <div id="graduation-div" className='h-24 my-10 animate__animated '>
          <div className='flex justify-center items-center '>
            ...
            <p className='text-white font-play ml-2 text-2xl'>Bachelor of Graphic Design - UEMG</p>
          </div>
          <div className='flex justify-center items-center h-24'>
            <img src={tube} className="w-5" alt="icone tubo de ensaio" />
            <p className='text-white font-play ml-2 text-2xl'>Bachelor of Chemistry - UFMG</p>
          </div>
        </div>
        ...
        <div id='master-div' className='h-24 my-10 hidden animate__animated '>
          <div className='flex justify-center items-center '>
            ...
            <p className='text-white font-play ml-2 text-2xl'>Master in Technological Education
              CEFET-MG</p>
          </div>
        </div>
        ...
        <div id='dev-div' className='h-24 my-10 hidden animate__animated '>
          <div className='flex justify-center items-center '>
            <img src={palete} className="w-5" alt="icone paleta de cor" />
            <p className='text-white font-play ml-2 text-2xl'>Full-Stack development - Trybe</p>
          </div>
        </div>
